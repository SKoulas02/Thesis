# GENERATED by make_family_build.py for 4x32 (4x32, 32 channels).
...
# GENERATED for 4x32: the two config-specific files come from the
# family build dir; everything else is the shared verified engine.
set gsrc   "$repo/family_builds/4x32"
...
if {[llength $gmissing]} {
    ...
    say "         scp -r family_builds/4x32 <server>:$repo/family_builds/"
    return
}
...
if {[phase 1]} {
    ...
    set streams {
        00 {s_axis_w0    read_only}
        01 {s_axis_w1    read_only}
        02 {s_axis_w2    read_only}
        03 {s_axis_w3    read_only}
        04 {s_axis_w4    read_only}
        05 {s_axis_w5    read_only}
        06 {s_axis_w6    read_only}
        07 {s_axis_w7    read_only}
        08 {s_axis_w8    read_only}
        09 {s_axis_w9    read_only}
        10 {s_axis_w10   read_only}
        11 {s_axis_w11   read_only}
        12 {s_axis_w12   read_only}
        13 {s_axis_w13   read_only}
        14 {s_axis_w14   read_only}
        15 {s_axis_w15   read_only}
        16 {s_axis_ind0  read_only}
        17 {s_axis_ind1  read_only}
        18 {s_axis_ind2  read_only}
        19 {s_axis_ind3  read_only}
        20 {s_axis_ind4  read_only}
        21 {s_axis_ind5  read_only}
        22 {s_axis_a0    read_only}
        23 {s_axis_a1    read_only}
        24 {m_axis_c0    write_only}
        25 {m_axis_c1    write_only}
        26 {m_axis_c2    write_only}
        27 {m_axis_c3    write_only}
        28 {m_axis_c4    write_only}
        29 {m_axis_c5    write_only}
        30 {m_axis_c6    write_only}
        31 {m_axis_c7    write_only}
    }
