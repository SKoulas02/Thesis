...
end entity matrix_transposer;

architecture matrix_arch of matrix_transposer is
                ...
                if we = '1' then
                    ...
                    if re = '1' then
                        for c in 0 to COLS - 1 loop
                            ...
                            for r in 0 to ROWS-2 loop
                                matrix_reg(r, c) <= matrix_reg(r+1,c);
                            end loop;

                            DATA_OUT(((c + 1) * DATAW) - 1 downto c * DATAW) <= matrix_reg(0, c);
