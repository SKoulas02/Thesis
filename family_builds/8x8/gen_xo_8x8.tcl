# GENERATED by make_family_build.py for 8x8 (8x8, 17 channels).
...
# GENERATED for 8x8: the two config-specific files come from the
# family build dir; everything else is the shared verified engine.
set gsrc   "$repo/family_builds/8x8"
...
if {[llength $gmissing]} {
    ...
    say "         scp -r family_builds/8x8 <server>:$repo/family_builds/"
    return
}
...
if {[phase 1]} {
    ...
    set streams {
        ...
        08 {s_axis_ind0  read_only}
        09 {s_axis_ind1  read_only}
        10 {s_axis_ind2  read_only}
        11 {s_axis_a0    read_only}
        12 {s_axis_a1    read_only}
        13 {m_axis_c0    write_only}
        14 {m_axis_c1    write_only}
        15 {m_axis_c2    write_only}
