...
end entity matrix_fifo_1024;

architecture matrix_fifo_arch of matrix_fifo_1024 is
    ...
    type matrix_array is array(natural range <>) of std_logic_vector ((BUS_EL*EL_SIZE/2)-1 downto 0);
...
begin
    ...
    PACK_MATRIX : for i in 0 to A_ROWS-1 generate
        A_out(((i+1) * (BUS_EL*EL_SIZE/2)) - 1 downto i * (BUS_EL*EL_SIZE/2)) <= A_out_internal(i);
    end generate;
