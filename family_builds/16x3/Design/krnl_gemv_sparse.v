...
// (16 cores x 3 blocks = 48 blocks, 384 DSPs, 13 AXI4-Stream ports).
//
...
// package_xo infers the 13 AXI4-Stream interfaces from them.
//
...
// drives it, so the wrapper accepts all 2 and leaves them unconnected.
//
// SPARSITY is NOT a port. The 2-bit code rides in the LAST index PC's padding,
// bits [481:480] of the joined 512-bit index word. It is buffer CONTENT written
