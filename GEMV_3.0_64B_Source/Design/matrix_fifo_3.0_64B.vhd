...
end entity matrix_fifo_64;

architecture matrix_fifo_arch of matrix_fifo_64 is
    ...
    constant IND_PACK   : integer := 4;  -- Number of rows of indices FIFO, used for RR logic);
