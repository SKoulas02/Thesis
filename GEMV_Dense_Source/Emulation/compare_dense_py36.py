...
PYTHON 3.6 COMPATIBLE COPY of compare_dense.py, for the university server
...
Behaviour, output and report format are otherwise IDENTICAL to compare_dense.py
...
tlast.txt  : from dense_TB.vhd       (one line per output beat: 1 / 0 / X)
