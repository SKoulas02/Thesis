...
# --- Configuration ---
ROWS              = 8      # Number of rows to generate (8 matrix rows * 4 cols / 2 elems-per-line)
ELEMENTS_PER_ROW  = 2      # Number of 4-bit indices per row
OUTPUT_FILE       = "Indices_8x2_SW.txt"
