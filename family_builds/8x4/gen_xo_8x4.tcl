# GENERATED by make_family_build.py for 8x4 (8x4, 10 channels).
...
# GENERATED for 8x4: the two config-specific files come from the
# family build dir; everything else is the shared verified engine.
set gsrc   "$repo/family_builds/8x4"
...
if {[llength $gmissing]} {
    ...
    say "         scp -r family_builds/8x4 <server>:$repo/family_builds/"
    return
}
...
if {[phase 1]} {
    ...
    set streams {
        ...
        04 {s_axis_ind0  read_only}
        05 {s_axis_ind1  read_only}
        06 {s_axis_a0    read_only}
        07 {s_axis_a1    read_only}
        08 {m_axis_c0    write_only}
        09 {m_axis_c1    write_only}
    }
