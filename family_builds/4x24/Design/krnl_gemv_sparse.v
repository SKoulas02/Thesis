...
// (4 cores x 24 blocks = 96 blocks, 768 DSPs, 24 AXI4-Stream ports).
//
...
// package_xo infers the 24 AXI4-Stream interfaces from them.
//
...
// drives it, so the wrapper accepts all 4 and leaves them unconnected.
//
// SPARSITY is NOT a port. The 2-bit code rides in the LAST index PC's padding,
// bits [961:960] of the joined 1024-bit index word. It is buffer CONTENT written
