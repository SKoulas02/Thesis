# GENERATED by make_family_build.py for 4x4 (4x4, 6 channels).
...
# GENERATED for 4x4: the two config-specific files come from the
# family build dir; everything else is the shared verified engine.
set gsrc   "$repo/family_builds/4x4"
...
if {[llength $gmissing]} {
    ...
    say "         scp -r family_builds/4x4 <server>:$repo/family_builds/"
    return
}
...
if {[phase 1]} {
    ...
    set streams {
        ...
        02 {s_axis_ind0  read_only}
        03 {s_axis_a0    read_only}
        04 {s_axis_a1    read_only}
        05 {m_axis_c0    write_only}
    }
