# GENERATED by make_family_build.py for 16x3 (16x3, 13 channels).
...
# GENERATED for 16x3: the two config-specific files come from the
# family build dir; everything else is the shared verified engine.
set gsrc   "$repo/family_builds/16x3"
...
if {[llength $gmissing]} {
    ...
    say "         scp -r family_builds/16x3 <server>:$repo/family_builds/"
    return
}
...
if {[phase 1]} {
    ...
    set streams {
        ...
        06 {s_axis_ind0  read_only}
        07 {s_axis_ind1  read_only}
        08 {s_axis_a0    read_only}
        09 {s_axis_a1    read_only}
        10 {m_axis_c0    write_only}
        11 {m_axis_c1    write_only}
        12 {m_axis_c2    write_only}
    }
