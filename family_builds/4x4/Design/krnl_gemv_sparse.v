...
// (4 cores x 4 blocks = 16 blocks, 128 DSPs, 6 AXI4-Stream ports).
//
...
// package_xo infers the 6 AXI4-Stream interfaces from them.
//
...
// drives it, so the wrapper accepts all 1 and leaves them unconnected.
//
// SPARSITY is NOT a port. The 2-bit code rides in the LAST index PC's padding,
// bits [161:160] of the joined 256-bit index word. It is buffer CONTENT written
