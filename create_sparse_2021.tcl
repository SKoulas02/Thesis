...
#   <root>/create_sparse_2021.tcl
#   <root>/GEMV_4.0_Source/{Design,Simulation,Emulation}, timing.xdc
#
# USAGE
#   vivado -mode batch -source create_sparse_2021.tcl -nojournal -nolog
#   vivado -mode batch -source create_sparse_2021.tcl -tclargs impl   ;# + synth/impl
#
...
#   batch : vivado -mode batch -source create_sparse_2021.tcl -tclargs impl
