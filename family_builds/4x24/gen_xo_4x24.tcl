# GENERATED by make_family_build.py for 4x24 (4x24, 24 channels).
...
# GENERATED for 4x24: the two config-specific files come from the
# family build dir; everything else is the shared verified engine.
set gsrc   "$repo/family_builds/4x24"
...
if {[llength $gmissing]} {
    ...
    say "         scp -r family_builds/4x24 <server>:$repo/family_builds/"
    return
}
...
if {[phase 1]} {
    ...
    set streams {
        ...
        12 {s_axis_ind0  read_only}
        13 {s_axis_ind1  read_only}
        14 {s_axis_ind2  read_only}
        15 {s_axis_ind3  read_only}
        16 {s_axis_a0    read_only}
        17 {s_axis_a1    read_only}
        18 {m_axis_c0    write_only}
        19 {m_axis_c1    write_only}
        20 {m_axis_c2    write_only}
        21 {m_axis_c3    write_only}
        22 {m_axis_c4    write_only}
        23 {m_axis_c5    write_only}
    }
