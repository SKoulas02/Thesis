...
end entity vector_fifo_1024;

architecture vector_fifo_arch of vector_fifo_1024 is
    ...
    signal din      : std_logic_vector (512 downto 0);
    signal dout     : std_logic_vector (512 downto 0);
...
begin
    ...
    B_vector_out    <= dout(512 downto 1);
